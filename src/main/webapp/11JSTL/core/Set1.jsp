...
<body>
	...
	<c:set var="paersonVar2" value="<%= new Person() %>" scope="request" />
	<c:set target="${ paersonVar2 }" property="name" value="정약용" />
	<c:set target="${ paersonVar2 }" property="age" value="60" />
	<ul>
